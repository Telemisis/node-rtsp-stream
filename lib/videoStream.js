...
(function() {
  ...
  VideoStream.prototype.pipeStreamToSocketServer = function () {
		...
		var cfg = {
			ssl: true,
			port: this.wsPort,
			ssl_key: 'c:\\telemisis\\sitepro\\v5.0\\web\\ssl\\telemisis.com.key',
			ssl_cert: 'c:\\telemisis\\sitepro\\v5.0\\web\\ssl\\telemisis.com.crt'
		};
  ...
  VideoStream.prototype.onSocketConnect = function(socket) {
    ...
    this.logger.info(("" + this.name + ": New WebSocket Connection (") + this.wsServer.clients.length + " total)");
    return socket.on("close", function(code, message) {
      return self.logger.info(("" + this.name + ": Disconnected WebSocket (") + self.wsServer.clients.length + " total)");
    });
  };
